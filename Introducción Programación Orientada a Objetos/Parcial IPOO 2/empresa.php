...
class Empresa {
    ...
    /**
     * Rrecorre la colección de ventas realizadas por la empresa y retorna el importe total de ventas 
    ...
    public function informarSumaVentasNacionales() {
        ...
        foreach ($coleVentas as $venta) {
            ...
            $importeTotalN = $importeTotalN + $importe;
        }
        return $importeTotalN;
    }

    /**
     * Recorre la colección de ventas realizadas por la empresa y retorna una colección de 
     * ventas de bicicletas  importadas. Si en la venta al menos una de las bicicletas es importada la 
    ...
    public function informarVentasImportadas() {
        ...
        foreach ($coleVentas as $venta) {
            $ventaImp = $venta -> retornarBicicletasImportadas();
            if ($ventaImp <> []) { 
                array_push($coleccionVentasImportadas, $venta);
            }
        }
